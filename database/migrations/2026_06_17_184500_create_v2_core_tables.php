...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('v2_integration_accounts')) {
        ...
        if (! Schema::hasTable('v2_lead_sources')) {
        ...
        if (! Schema::hasTable('v2_conversations')) {
        ...
        if (! Schema::hasTable('v2_messages')) {
        ...
        if (! Schema::hasTable('v2_campaign_runs')) {
        ...
        if (! Schema::hasTable('v2_campaign_steps')) {
        ...
        if (! Schema::hasTable('v2_provider_events')) {
