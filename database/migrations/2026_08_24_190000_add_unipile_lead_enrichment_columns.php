...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasColumn('audience_lists', 'con_phone')) {
        ...
        if (! Schema::hasColumn('sn_leads', 'email_fetch_status')) {
            Schema::table('sn_leads', function (Blueprint $table) {
                ...
                $table->string('phone', 50)->nullable()->after('email_fetch_attempted_at');
        ...
        if (! Schema::hasTable('v2_lead_contact_overlays')) {
