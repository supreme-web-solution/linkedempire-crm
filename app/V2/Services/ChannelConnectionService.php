...
class ChannelConnectionService
{
    ...
    {
        $channel = OutreachChannelRegistry::allChannels()[$channelKey] ?? null;
        if ($channel === null) {
            throw new \InvalidArgumentException("Unknown channel: {$channelKey}");
        }
     ...
     * @return array<string, mixed>
     */
    private function appendHostedAuthReconnect(array $context, ?V2IntegrationAccount $existing, string $channelKey): array
    {
