...
<div class="mt-4">
    <div class="border-b border-gray-200 bg-white rounded-lg">
        <nav class="flex flex-wrap gap-x-4" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
            ...
            <a href="{{route('calls.reminders')}}" class="py-4 px-2 inline-flex items-center gap-x-2 border-b-2 border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-blue-600 focus:outline-hidden focus:text-blue-600">
                Call Reminders
            </a>
        </nav>
    </div>
