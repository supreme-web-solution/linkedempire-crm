    ...
    <div class="p-6 sm:p-8 lg:p-10 order-1 lg:order-2 flex flex-col justify-center">
        ...
        <form method="post" action="{{route('register.fe.auth')}}">
            ...
            <div>
                ...
                <div class="relative">
                <input type="password" id="fe-password" name="password" class="py-2.5 sm:py-3 px-4 pe-10 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-[#0077b5] focus:ring-[#0077b5] disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="password-error">
