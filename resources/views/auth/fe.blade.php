...
@seo([
        'title' => 'FE Signup - ' . config('app.name'),
...
<div class="w-full grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[420px] rounded-xl overflow-hidden border border-gray-200 shadow-lg bg-white">
    ...
    <div class="p-6 sm:p-8 lg:p-10 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 border-b lg:border-b-0 lg:border-r border-blue-200/60 order-2 lg:order-1 flex flex-col justify-center relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <p class="text-base text-gray-700 mb-6 leading-relaxed">You have made a great decision, as the app is result-oriented.</p>
            ...
            <div class="p-4 bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-yellow-500 rounded-lg shadow-sm">
                ...
                <p class="text-sm text-gray-800 leading-relaxed">Please create your account using your preferred details below.</p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6 sm:p-8 lg:p-10 order-1 lg:order-2 flex flex-col justify-center">
        <div class="text-center lg:text-left">
            <h1 class="block text-2xl font-bold text-gray-900">FE Signup</h1>
        ...
        <div class="mt-5">
        <!-- Form -->
        <form method="post" action="{{route('register.fe.auth')}}">
            @csrf
            ...
            <!-- Form Group -->
            <div>
                <label for="fe-password" class="block text-sm mb-2 text-gray-700">Password</label>
                <div class="relative">
                <input type="password" id="fe-password" name="password" placeholder="Enter your password" class="py-2.5 sm:py-3 px-4 pe-10 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-[#0077b5] focus:ring-[#0077b5] disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="password-error">
                <button type="button" onclick="toggleFePassword()"
                    class="absolute inset-y-0 end-0 flex items-center pe-3 cursor-pointer hover:text-[#0077b5] transition-colors"
                    aria-label="Toggle password visibility">
                    <svg id="fe-password-eye" class="size-5 text-gray-400" width="20" height="20"
                    ...
                    <svg id="fe-password-eye-slash" class="size-5 text-gray-400 hidden" width="20"
...
<script>
    function toggleFePassword() {
        const passwordInput = document.getElementById('fe-password');
        const eyeIcon = document.getElementById('fe-password-eye');
        const eyeSlashIcon = document.getElementById('fe-password-eye-slash');
